;;deityos theme
;;Author: Mac Henni
;;emacs theme for deityos
;;Code here
(deftheme deityos
  "Theme for deityos, a better TempleOS")

(custom-theme-set-faces
 'DeityOS
 '(default ((t (:family "Ubuntu Mono" :foundry "DAMA" :width normal :height 120 :weight normal :slant normal :underline nil :overline nil :extend nil :strike-through nil :box nil :inverse-video nil :foreground "gray46" :background "snow3" :stipple nil :inherit nil))))
 '(cursor ((t (:background "gray46"))))
 '(fixed-pitch ((t (:family "Monospace"))))
 '(variable-pitch ((((type w32)) (:foundry "outline" :family "Arial")) (t (:family "Sans Serif"))))
 '(escape-glyph ((((background dark)) (:foreground "cyan")) (((type pc)) (:foreground "magenta")) (t (:foreground "brown"))))
 '(homoglyph ((((background dark)) (:foreground "cyan")) (((type pc)) (:foreground "magenta")) (t (:foreground "brown"))))
 '(minibuffer-prompt ((t (:weight bold))))
 '(highlight ((t (:box (:line-width 2 :color "white" :style released-button) :foreground "white" :background "green"))))
 ...
 '(tooltip ((t (:foreground "white smoke" :background "gray65" :inherit (variable-pitch)))))
 '(mode-line ((t (:weight normal :background "MistyRose2"))))
 ...
 '(match ((t (:box (:line-width 2 :color nil :style nil) :background "yellow1"))))
 '(next-error ((t (:inherit (region)))))
 '(query-replace ((t (:inherit (isearch))))))

(provide-theme 'DeityOS)
